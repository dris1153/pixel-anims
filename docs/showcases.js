...
window.SHOWCASES = [
  {
    ...
    prompt: 'A pixel art wizard casting a spell: idle bob with beard sway, staff raises while sparks spiral into the gem, ' +
  ...
  },
  {
    ...
    prompt: 'Pixel art knight: idle, wind-up, sword slash with an arc trail and sparks, recover. Castle rampart at dusk.',
  },
  {
    ...
    kind: 'Made with the skill',
    prompt: 'Pixel art dragon: idle breathing, inhale, fire-breath stream with embers, recover. Rocky cliff, red moon.',
  },
  {
    ...
    kind: 'Made with the skill',
    prompt: 'Pixel art ninja: idle stance, crouching wind-up, throws a spinning shuriken that flies across the scene, ' +
