...
`vn.svg`, `cn.svg`, `jp.svg`, `kr.svg`, `th.svg`, `in.svg`, `ru.svg`, `gr.svg`, `eg.svg`, `no.svg`, `es.svg`, `ph.svg`, `tr.svg`, `fr.svg`, `us.svg`, `dk.svg`, `de.svg`, `br.svg`, `iq.svg`, `ir.svg`, `mx.svg`, `pe.svg`, `ie.svg`, `id.svg` and `gb-eng.svg` (England, its ISO 3166-2 code) are from [pixel-flags](https://github.com/tgines/pixel-flags) by Tony Gines,
